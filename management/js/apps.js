...
var ChartOptions = {
        ...
        responsive: !0,
        legend: { display: !1 },
        scales: { xAxes: [{ gridLines: { display: !1 } }], yAxes: [{ gridLines: { display: !1, color: colors.borderColor, zeroLineColor: colors.borderColor } }] },
    },
    ChartData = {
    ...
    pieChartData = { labels: ["Kadın", "Erkek", "Belirtilmedi"], datasets: [{ data: [, , ], backgroundColor: ['#FF6384', '#36A2EB', '#FFCE56'], borderColor: '#ffffff' }] },
    areaChartData = {
...
areaChartjs && new Chart(areaChartjs, { type: "line", data: areaChartData, options: ChartOptions }),
    $(".sparkline").length &&
...
svgg4 && (gauge4 = Gauge(document.getElementById("gauge4"), { max: 500, dialStartAngle: 90, dialEndAngle: 0, value: 50 }));
