...
var columnChart,
    columnChartoptions = {
        series: [
            { name: "Orders", data: [32, 66, 44, 55, 41, 24, 67, 22, 43, 32, 66, 44, 55, 41, 24, 67, 22, 43] },
            { name: "Visitors", data: [7, 30, 13, 23, 20, 12, 8, 13, 27, 7, 30, 13, 23, 20, 12, 8, 13, 27] },
        ],
        chart: { type: "bar", height: 350, stacked: !1, columnWidth: "70%", zoom: { enabled: !0 }, toolbar: { show: !1 }, background: "transparent" },
        ...
        xaxis: {
            ...
            labels: { show: !0, trim: !0, minHeight: void 0, maxHeight: 120, style: { colors: colors.mutedColor, cssClass: "text-muted", fontFamily: base.defaultFontFamily } },
            axisBorder: { show: !1 },
        },
        yaxis: { labels: { show: !0, trim: !1, offsetX: -10, minHeight: void 0, maxHeight: 120, style: { colors: colors.mutedColor, cssClass: "text-muted", fontFamily: base.defaultFontFamily } } },
        legend: {
            position: "top",
            fontFamily: base.defaultFontFamily,
            fontWeight: 400,
            labels: { colors: colors.mutedColor, useSeriesColors: !1 },
            markers: { width: 10, height: 10, strokeWidth: 0, strokeColor: "#fff", fillColors: [extend.primaryColor, extend.primaryColorLighter], radius: 6, customHTML: void 0, onClick: void 0, offsetX: 0, offsetY: 0 },
...
var barChart,
    barChartoptions = {
        ...
        xaxis: {
            ...
            labels: { show: !0, trim: !1, minHeight: void 0, maxHeight: 120, style: { colors: colors.mutedColor, cssClass: "text-muted", fontFamily: base.defaultFontFamily } },
            axisBorder: { show: !1 },
        },
        yaxis: { labels: { show: !0, trim: !1, offsetX: -5, minHeight: void 0, maxHeight: 120, style: { colors: colors.mutedColor, cssClass: "text-muted", fontFamily: base.defaultFontFamily } } },
        legend: {
            position: "bottom",
            fontFamily: base.defaultFontFamily,
            fontWeight: 400,
            labels: { colors: colors.mutedColor, useSeriesColors: !1 },
            offsetY: 10,
            markers: { width: 10, height: 10, strokeWidth: 0, strokeColor: colors.borderColor, fillColors: chartColors, radius: 6, customHTML: void 0, onClick: void 0, offsetX: 0, offsetY: 0 },
            itemMargin: { horizontal: 10, vertical: 0 },
            onItemClick: { toggleDataSeries: !0 },
            onItemHover: { highlightDataSeries: !0 },
        },
...
var areachart,
    areaChartOptions = {
        ...
        chart: { type: "area", height: 350, background: "transparent", stacked: !0, toolbar: { show: !1 }, zoom: { enabled: !1 } },
        theme: { mode: colors.chartTheme },
        xaxis: {
            type: "datetime",
            categories: [
...
var lineChartWidget,
    lineChartWidgetoptions = {
        series: [
            { name: "Page views", data: [31, 28, 30, 51, 42, 88, 86, 31, 40, 28, 31, 58, 30, 51, 42, 109, 100, 116] },
            { name: "Visitors", data: [11, 45, 20, 32, 34, 52, 41, 11, 32, 45, 11, 75, 20, 32, 34, 52, 41, 81] },
        ],
    ...
    radialbarWidgetOptions = {
        ...
        plotOptions: {
            radialBar: {
                ...
                dataLabels: {
                    show: !0,
                    name: { fontSize: "0.875rem", fontWeight: 400, offsetY: -10, show: !1, color: colors.mutedColor, fontFamily: base.defaultFontFamily },
                    value: {
                    ...
                    total: { show: !1, fontSize: "0.875rem", fontWeight: 400, offsetY: -10, label: "Percent", color: colors.mutedColor, fontFamily: base.defaultFontFamily },
                },
            },
        },
        fill: {
            type: "gradient",
            gradient: { shade: "light", type: "diagonal2", shadeIntensity: 0.2, gradientFromColors: [extend.primaryColorLighter], gradientToColors: [base.primaryColor], inverseColors: !0, opacityFrom: 1, opacityTo: 1, stops: [20, 100] },
        },
...
var radarChartWidget,
    radarChartWidgetOptions = {
        ...
        theme: { mode: colors.chartTheme },
        plotOptions: { radar: { polygons: { strokeColors: colors.borderColor, strokeWidth: 1, connectorColors: colors.borderColor, fill: { colors: ["transparent"] } } } },
        legend: { show: !1 },
        stroke: { width: 1, colors: chartColors },
        fill: { opacity: 1, colors: chartColors },
        markers: { size: 0 },
        yaxis: { labels: { style: { colors: colors.mutedColor, fontFamily: base.defaultFontFamily } } },
        xaxis: { categories: ["01", "02", "03", "04", "05", "06"], labels: { title: { colors: colors.mutedColor, fontFamily: base.defaultFontFamily } } },
...
var barChartWidget,
    barChartWidgetoptions = {
        ...
        xaxis: { categories: ["Monday", "Tuesday", "Wednesday", "Thusday", "Friday", "Saturday", "Sunday"], labels: { show: !1 }, axisBorder: { show: !1 }, axisTicks: { show: !1 } },
...
var areaChartWidget,
    areaChartWidgetOptions = {
        series: [
            { name: "Website", data: [31, 28, 30, 51, 42, 109, 100, 31, 40, 28, 31, 58, 30, 51, 42, 109, 100, 98] },
            { name: "Mobile Apps", data: [11, 45, 20, 32, 34, 52, 41, 11, 32, 45, 11, 75, 20, 32, 34, 52, 41, 50] },
...
var columnChartWidget,
    columnChartWidgetoptions = {
        series: [
            { name: "Orders", data: [32, 66, 44, 55, 41, 24, 67, 22, 43, 32, 66, 44, 55] },
...
var heatmapchart,
    heatmapChartOptions = {
        series: [
            { name: "Set 1", data: [61, 98, 16, 9, 97, 20, 14, 18, 19, 33, 76, 78, 63, 89, 99, 30] },
            { name: "Set 2", data: [77, 76, 10, 47, 13, 56, 71, 83, 32, 57, 87, 96, 99, 85, 1, 15] },
            { name: "Set 3", data: [48, 23, 27, 90, 37, 32, 88, 96, 65, 46, 63, 17, 40, 42, 77, 41] },
            { name: "Set 4", data: [70, 33, 71, 90, 34, 63, 93, 80, 39, 40, 41, 67, 86, 8, 91, 79] },
            { name: "Set 5", data: [78, 98, 19, 74, 41, 59, 95, 99, 37, 17, 11, 60, 44, 7, 61, 39] },
            { name: "Set 6", data: [46, 95, 52, 36, 34, 65, 2, 3, 13, 77, 72, 71, 93, 25, 83, 98] },
            { name: "Set 7", data: [2, 93, 68, 3, 53, 56, 79, 64, 46, 14, 22, 94, 60, 81, 51, 15] },
            { name: "Set 8", data: [13, 1, 45, 30, 19, 71, 86, 51, 59, 9, 28, 95, 61, 6, 37, 54] },
        ],
        ...
        xaxis: {
            ...
            labels: { show: !0, trim: !1, minHeight: void 0, maxHeight: 100, style: { fontSize: "0.875rem", colors: colors.mutedColor, cssClass: "text-muted", fontFamily: base.defaultFontFamily } },
            axisBorder: { show: !1 },
        },
        yaxis: { labels: { show: !0, trim: !1, offsetX: -10, minHeight: void 0, maxHeight: 120, style: { fontSize: "0.875rem", colors: colors.mutedColor, cssClass: "text-muted", fontFamily: base.defaultFontFamily } } },
        grid: {
            show: !0,
            borderColor: colors.borderColor,
            strokeDashArray: 0,
...
var bubblechart,
    bubbleChartOptions = {
        series: [
            { name: "Type 1", data: generateData(new Date("11 Feb 2017 GMT").getTime(), 20, { min: 10, max: 60 }) },
            { name: "Type 2", data: generateData(new Date("11 Feb 2017 GMT").getTime(), 20, { min: 10, max: 60 }) },
            { name: "Type 3", data: generateData(new Date("11 Feb 2017 GMT").getTime(), 20, { min: 10, max: 60 }) },
        ...
        dataLabels: { enabled: !1 },
        colors: chartColors,
        xaxis: { tickAmount: 12, type: "category", labels: { show: !0, trim: !1, minHeight: void 0, maxHeight: 120, style: { colors: colors.mutedColor, cssClass: "small" } }, axisBorder: { show: !1 } },
        yaxis: { labels: { show: !0, trim: !1, offsetX: -10, minHeight: void 0, maxHeight: 120, style: { colors: colors.mutedColor, cssClass: "small" } } },
        legend: {
            position: "top",
            fontFamily: base.defaultFontFamily,
            fontWeight: 400,
...
var radarchart,
    radarChartOptions = {
        ...
        theme: { mode: colors.chartTheme },
        plotOptions: { radar: { polygons: { strokeColors: colors.borderColor, strokeWidth: 1, connectorColors: colors.borderColor, fill: { colors: ["transparent"] } } } },
        legend: { fontFamily: base.defaultFontFamily, fontWeight: 400, labels: { colors: colors.mutedColor, useSeriesColors: !1 } },
...
var candlechart,
    candleChartOptions = {
        ...
        theme: { mode: colors.chartTheme },
        xaxis: { type: "datetime", labels: { show: !0, trim: !1, minHeight: void 0, maxHeight: 120, style: { colors: colors.mutedColor, cssClass: "small" } }, axisBorder: { show: !1 } },
        yaxis: { labels: { show: !0, trim: !1, offsetX: -10, minHeight: void 0, maxHeight: 120, style: { colors: colors.mutedColor, cssClass: "small" } } },
        grid: {
            show: !0,
            borderColor: colors.borderColor,
    ...
    radialbarOptions = {
        ...
        plotOptions: {
            radialBar: {
                ...
                dataLabels: {
                    show: !0,
                    name: { fontSize: "0.875rem", fontWeight: 400, offsetY: -10, show: !0, color: colors.mutedColor, fontFamily: base.defaultFontFamily },
                    value: {
                        formatter: function (e) {
                            return parseInt(e);
                        },
    ...
    multiRadialbarOptions = {
        ...
        plotOptions: {
            radialBar: {
                ...
                dataLabels: {
                    name: { fontSize: "0.875rem", fontWeight: 400, offsetY: -10, show: !0, color: colors.mutedColor, fontFamily: base.defaultFontFamily },
                    value: { fontSize: "1.53125rem", fontWeight: 700, fontFamily: base.defaultFontFamily, offsetY: 0, show: !0, color: colors.headingColor },
                    total: {
                        show: !0,
                        fontSize: "0.825rem",
                        fontWeight: 400,
    ...
    gradientRadialOptions = {
        ...
        plotOptions: {
            radialBar: {
                startAngle: -135,
                endAngle: 225,
                hollow: { margin: 0, size: "70%", background: colors.backgroundColor, image: void 0, imageOffsetX: 0, imageOffsetY: 0, position: "front" },
                ...
                dataLabels: {
                    ...
                    total: { show: !0, fontSize: "0.875rem", fontWeight: 400, offsetY: -10, color: colors.mutedColor, fontFamily: base.defaultFontFamily },
                },
            },
        },
        fill: { type: "gradient", gradient: { shade: "dark", type: "horizontal", shadeIntensity: 0.5, gradientToColors: ["#ABE5A1"], inverseColors: !0, opacityFrom: 1, opacityTo: 1, stops: [0, 100] } },
        stroke: { lineCap: "round" },
        labels: ["Percent"],
    },
    ...
    strokeRadialOptions = {
        ...
        plotOptions: {
            radialBar: {
                ...
                track: { background: colors.borderColor },
                dataLabels: {
                    name: { fontSize: "12px", color: colors.mutedColor, offsetY: 90, fontFamily: base.defaultFontFamily, fontWeight: 400 },
                    value: {
                        offsetY: 56,
                        fontSize: "20px",
                        fontWeight: 700,
    ...
    semiRadialOptions = {
        ...
        plotOptions: {
            radialBar: {
                ...
                dataLabels: { name: { show: !1 }, value: { offsetY: -2, fontSize: "20px", fontWeight: 700, color: colors.headingColor, fontFamily: base.defaultFontFamily } },
            },
        },
        grid: { padding: { top: -10 } },
